...
export const Step6Review: React.FC<Step6ReviewProps> = ({ audioSegments, onConfirm }) => {
  return (
    <div className="flex flex-col items-center">
      <h2 className="text-2xl font-semibold mb-4 text-center">Step 6: Review Audio Segments</h2>
