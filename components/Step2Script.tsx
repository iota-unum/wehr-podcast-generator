...
export const Step2Script: React.FC<Step2ScriptProps> = ({ script, onConfirm, onGoBack }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <h2 className="text-2xl font-semibold mb-4 text-center">Review & Edit Your Podcast Script</h2>
